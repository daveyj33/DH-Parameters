...
a1=pi/2;ac=pi/2; a2=0; a3=0;ab=pi/2; % the angle alpha between z_i1 and z_i measured about x_i 
...
r1=0;rc=.1; r2=.25; r3=.25; rb=.2; %  distance along x_i from O_i to the intersection of the x_i and z_i1 axes.
d1=.1; dc=0; d2=0; d3=0; db=0; % distance along z_i1 from O_i1 to the intersection of the x_i and z_i1 axes.
